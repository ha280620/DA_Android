...
public class VerifyOTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetOTP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(VerifyOTP.this, "Vui lòng đợi",Toast.LENGTH_SHORT).show();
                sendVerificationCode("+84" + phone_number);
            }
        });
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            ...
            Toast.makeText(VerifyOTP.this, "Thất bại", Toast.LENGTH_SHORT).show();
            if (e instanceof FirebaseAuthInvalidCredentialsException) {
                Toast.makeText(VerifyOTP.this, "yêu cầu thất bại", Toast.LENGTH_SHORT).show();
            } else if (e instanceof FirebaseTooManyRequestsException) {
                Toast.makeText(VerifyOTP.this, "Quota không đủ", Toast.LENGTH_SHORT).show();
            }
        }
        /*fail
        @Override
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(VerifyOTP.this, "Hoàn thành xác thực. Đăng nhập thành công.", Toast.LENGTH_SHORT).show();
                            //lưu dữ liệu lên firebase và bắt sự kiện khi hoàn thành valur
                            mDatabase.child("Account").push().setValue(new UserAccounts(fullname, phone_number, password),
                                    new DatabaseReference.CompletionListener() {
                                        @Override
                                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                            if (error == null)
                                                Toast.makeText(VerifyOTP.this, "Lưu thông tin thành công. Vui lòng xác thực số điện thoại", Toast.LENGTH_SHORT).show();
                                            else
                                                Toast.makeText(VerifyOTP.this, "Thông tin chưa được cập nhật", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(VerifyOTP.this, "Xác thực thất bại. Vui lòng kiểm tra lại.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
